...
public class RestaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RestaActivity.this);
        builder.setTitle("Como Restar");
        builder.setMessage("Vamos a ver un ejemplo. \n Restemos 83 - 13 \n Ponemos el 83 y debajo 13, haciendo que coincidan las unidades, es decir, el 3 y el 3.\n Restemos 3 - 3 = 0 y lo ponemos debajo de la columna de las unidades.\n Restemos 8 - 1 = 7 y lo ponemos debajo de la columna de las decenas.\n Y como resultado tendremos 70.");
        ...
        btn_puntaje.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { ;
                AlertDialog.Builder builder7 = new AlertDialog.Builder(RestaActivity.this);
            ...
            public void onClick(View v) {
                ...
                if (res_usr == res_cor) {
                    ...
                    if (acum==5){
                        ...
                        acum=0;
                        if (cora == 10) {
                            AlertDialog.Builder builder4 = new AlertDialog.Builder(RestaActivity.this);
                            ...
                            builder4.setNegativeButton("No", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent i = new Intent(RestaActivity.this, GameActivity.class);
                                    startActivity(i);
                                }
                            });
                            builder4.show();
                    ...
                    if (cora<0){
                        AlertDialog.Builder builder3 = new AlertDialog.Builder(RestaActivity.this);
                    ...
                    btn_cora.setText(Integer.toString(cora));
                    acum = 0;
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(RestaActivity.this);
                    builder1.setTitle("ERROR");
                    builder1.setMessage("El resultado de la resta de " +num1 +" - " +num2 +" era "+res_cor);
